...
class EtapWtSldService:
    ...
    def _create_SLD_xml_element(self):
        ...
        for i in range(len(df1)):
            ...
            if inverter_type in ['INV_Type_1', 'INV_Type_2', 'INV_Type_3']:
                ...
                df1.at[i, 'Type_and_Control'] = int(get_param(2))
                df1.at[i, 'Rated_Real_Power'] = int(get_param(5))
                df1.at[i, 'Rated_Voltage'] = int(get_param(6))
                df1.at[i, 'Rated_PF'] = int(get_param(7))
                df1.at[i, 'Rated_Efficiency'] = int(get_param(8))
                df1.at[i, 'Poles'] = int(get_param(9))
                df1.at[i, 'Vmin'] = int(get_param(10))
                df1.at[i, 'Vmax'] = int(get_param(11))
                df1.at[i, 'Locked_Rotor_RLC'] = int(get_param(12))
                df1.at[i, 'Locked_Rotor_PF'] = int(get_param(13))
                df1.at[i, 'Std_MF'] = int(get_param(14))
            ...
            if df1.at[i, 'From_Device_Type'] == 'Gen':
                 ...
                 all_layout.append(f"""<BUS ID="{df1.at[i, 'LV_Bus_ID']}" LocX="{df1.at[i, 'LV_Bus_locX']}" LocY="{df1.at[i, 'LV_Bus_locY']}" Orientation="90" Len_D2D="{len_d2d}" NominalkV="{df1.at[i, 'SECKV']}"/>""")

                 # WTGENS
                 num = df1.at[i, 'Number_of_Inverter']
                 
                 if num >= 1:
                    all_layout.append(f"""<WTGEN ID="{df1.at[i, 'Inv_A_ID']}" LocX="{df1.at[i, 'Inv_A_locX']}" LocY="{df1.at[i, 'Inv_A_locY']}" Orientation="90" GeneratorType="{df1.at[i, 'Type_and_Control']}" MW="{df1.at[i, 'Rated_Real_Power']}" KV="{df1.at[i, 'Rated_Voltage']}" PowerFactor="{df1.at[i, 'Rated_Efficiency']}" Efficiency="{int(df3.iat[8, 1])}" Poles="{df1.at[i, 'Poles']}" Vmin="{df1.at[i, 'Vmin']}" Vmax="{df1.at[i, 'Vmax']}" LRC="{df1.at[i, 'Locked_Rotor_PF']}" PFlr="{df1.at[i, 'Locked_Rotor_PF']}" ANSIMF="{df1.at[i, 'Std_MF']}"/>""")
                 
                 if num >= 2:
                    all_layout.append(f"""<WTGEN ID="{df1.at[i, 'Inv_B_ID']}" LocX="{df1.at[i, 'Inv_B_locX']}" LocY="{df1.at[i, 'Inv_B_locY']}" Orientation="90" GeneratorType="{df1.at[i, 'Type_and_Control']}" MW="{df1.at[i, 'Rated_Real_Power']}" KV="{df1.at[i, 'Rated_Voltage']}" PowerFactor="{df1.at[i, 'Rated_Efficiency']}" Efficiency="{int(df3.iat[8, 1])}" Poles="{df1.at[i, 'Poles']}" Vmin="{df1.at[i, 'Vmin']}" Vmax="{df1.at[i, 'Vmax']}" LRC="{df1.at[i, 'Locked_Rotor_PF']}" PFlr="{df1.at[i, 'Locked_Rotor_PF']}" ANSIMF="{df1.at[i, 'Std_MF']}"/>""")
                 
                 if num >= 3:
                     all_layout.append(f"""<WTGEN ID="{df1.at[i, 'Inv_C_ID']}" LocX="{df1.at[i, 'Inv_C_locX']}" LocY="{df1.at[i, 'Inv_C_locY']}" Orientation="90" GeneratorType="{df1.at[i, 'Type_and_Control']}" MW="{df1.at[i, 'Rated_Real_Power']}" KV="{df1.at[i, 'Rated_Voltage']}" PowerFactor="{df1.at[i, 'Rated_Efficiency']}" Efficiency="{int(df3.iat[8, 1])}" Poles="{df1.at[i, 'Poles']}" Vmin="{df1.at[i, 'Vmin']}" Vmax="{df1.at[i, 'Vmax']}" LRC="{df1.at[i, 'Locked_Rotor_PF']}" PFlr="{df1.at[i, 'Locked_Rotor_PF']}" ANSIMF="{df1.at[i, 'Std_MF']}"/>""")
                 
                 if num >= 4:
                     all_layout.append(f"""<WTGEN ID="{df1.at[i, 'Inv_D_ID']}" LocX="{df1.at[i, 'Inv_D_locX']}" LocY="{df1.at[i, 'Inv_D_locY']}" Orientation="90" GeneratorType="{df1.at[i, 'Type_and_Control']}" MW="{df1.at[i, 'Rated_Real_Power']}" KV="{df1.at[i, 'Rated_Voltage']}" PowerFactor="{df1.at[i, 'Rated_Efficiency']}" Efficiency="{int(df3.iat[8, 1])}" Poles="{df1.at[i, 'Poles']}" Vmin="{df1.at[i, 'Vmin']}" Vmax="{df1.at[i, 'Vmax']}" LRC="{df1.at[i, 'Locked_Rotor_PF']}" PFlr="{df1.at[i, 'Locked_Rotor_PF']}" ANSIMF="{df1.at[i, 'Std_MF']}"/>""")
    ...
    def _generate_all_connections(self, df_elements: pd.DataFrame):
         ...
         for _, row in df_ids.iterrows():
             # XFORM3W specific logic for UNIT cables
             if self.mpt_type == 'XFORM3W':
                 if row["To_Device_Type"] == 'UNIT':
                     ...
                     connections.append(f'''<CONNECT FromElement="{cable_info.get("ElementType", "CABLE")}" FromID="{cable_id}" FromIID="{cable_info.get("IID", "0")}" FromExtRef="0" FromPin="0" FromCloneGuid="" ToElement="{to_info.get("ElementType", "BUS")}" ToID="{to_id}" ToIID="{to_info.get("IID", "0")}" ToExtRef="0" ToPin="0" ToCloneGuid=""/>''')
             ...
             connections.append(f'''<CONNECT FromElement="{cable_info.get("ElementType", "CABLE")}" FromID="{cable_id}" FromIID="{cable_info.get("IID", "0")}" FromExtRef="0" FromPin="0" FromCloneGuid="" ToElement="{from_info.get("ElementType", "BUS")}" ToID="{from_id}" ToIID="{from_info.get("IID", "0")}" ToExtRef="0" ToPin="1" ToCloneGuid=""/>''')
             connections.append(f'''<CONNECT FromElement="{cable_info.get("ElementType", "CABLE")}" FromID="{cable_id}" FromIID="{cable_info.get("IID", "0")}" FromExtRef="0" FromPin="1" FromCloneGuid="" ToElement="{to_info.get("ElementType", "BUS")}" ToID="{to_id}" ToIID="{to_info.get("IID", "0")}" ToExtRef="0" ToPin="0" ToCloneGuid=""/>''')
         ...
         for i in range(len(df_ids)):
            row = df_ids.iloc[i]
            wt_n = row.get("Number_of_Inverter")
            if pd.isna(wt_n):
                continue
            
            wt_n = int(float(wt_n))
            valid_labels = [chr(ord("A") + k) for k in range(wt_n)]

            for label in valid_labels:
                wt_col = f"Inv_{label}_ID"
                lv_bus_col = "LV_Bus_ID"
                
                wt_id = row.get(wt_col)
                lv_bus_id = row.get(lv_bus_col)
                
                if not wt_id:
                     continue
                
                wt_info = id_map.get(wt_id, {})
                lv_info = id_map.get(lv_bus_id, {})
                pin_num = ord(label) - ord("A") + 1
                
                connections.append(f'''<CONNECT FromElement="{wt_info.get("ElementType", "WTGEN")}" FromID="{wt_id}" FromIID="{wt_info.get("IID", "0")}" FromExtRef="0" FromPin="0" FromCloneGuid="" ToElement="{lv_info.get("ElementType", "BUS")}" ToID="{lv_bus_id}" ToIID="{lv_info.get("IID", "0")}" ToExtRef="0" ToPin="{pin_num}" ToCloneGuid=""/>''')
         ...
         connections.append(f'''<CONNECT FromElement="HVCB" FromID="Brkr_52L1" FromIID="{id_map.get('Brkr_52L1', {}).get('IID', '0')}" FromExtRef="0" FromPin="1" FromCloneGuid="" ToElement="BUS" ToID="52L1" ToIID="{id_map.get('52L1', {}).get('IID', '0')}" ToExtRef="0" ToPin="{int(unique_idx.max()) if len(unique_idx) > 0 else 0}" ToCloneGuid=""/>''')
